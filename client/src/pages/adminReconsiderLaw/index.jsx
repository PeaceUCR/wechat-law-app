...
import {adminReconsiderLawCategoryLines} from '../../util/util';
...
export default class Index extends Component {
  ...
  config = {
    navigationBarTitleText: '中华人民共和国行政复议法'
  }
      ...
      <View className={`litigation-regulation-page ${isReadMode ? 'read-mode' : ''}`}>
          ...
          <View>
            <View>
              ...
              <CategoryList isReadMode={isReadMode} type='' options={adminReconsiderLawCategoryLines} onClick={this.onClickOptionItem} />}
            </View>
            <View>
