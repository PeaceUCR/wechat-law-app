...
import {adminAllowLawCategoryLines} from '../../util/util';
      ...
      <View className={`litigation-regulation-page ${isReadMode ? 'read-mode' : ''}`}>
          ...
          <View>
            <View>
              ...
              <CategoryList isReadMode={isReadMode} type='' options={adminAllowLawCategoryLines} onClick={this.onClickOptionItem} />}
            </View>
            <View>
