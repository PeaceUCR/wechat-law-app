...
export default class Index extends Component {
  ...
  config = {
    navigationBarTitleText: '中华人民共和国劳动合同法'
  }
    ...
    return (
      <View className={`litigation-regulation-page ${isReadMode ? 'read-mode' : ''}`}>
          <AtNoticebar marquee speed={60}>
            已由中华人民共和国第十一届全国人民代表大会常务委员会第三十次会议于2012年12月28日通过《全国人民代表大会常务委员会关于修改〈中华人民共和国劳动合同法〉的决定》 自2013年7月1日起施行
          </AtNoticebar>
          <View>
            <AtSearchBar
              value={searchValue}
          ...
          <View>
            <View>
              ...
              <CategoryList isReadMode={isReadMode} type='' options={laborContractLawCategoryLines} onClick={this.onClickOptionItem} />}
            </View>
            <View>
