...
import {adminForceLawCategoryLines} from '../../util/util';
...
export default class Index extends Component {
  ...
  config = {
    navigationBarTitleText: '中华人民共和国行政强制法'
  }
      ...
      <View className={`litigation-regulation-page ${isReadMode ? 'read-mode' : ''}`}>
          ...
          <View>
            <View>
              ...
              <CategoryList isReadMode={isReadMode} type='' options={adminForceLawCategoryLines} onClick={this.onClickOptionItem} />}
            </View>
            <View>
