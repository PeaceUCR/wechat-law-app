...
import {antiTerrorismLawCategoryLines} from '../../util/util';
...
export default class Index extends Component {
  ...
  config = {
    navigationBarTitleText: '中华人民共和国反恐怖主义法'
  }
    ...
    return (
      <View className={`litigation-regulation-page ${isReadMode ? 'read-mode' : ''}`}>
          <AtNoticebar marquee speed={60}>
            根据2018年4月27日第十三届全国人民代表大会常务委员会第二次会议通过 全国人民代表大会常务委员会关于修改《中华人民共和国国境卫生检疫法》等六部法律的决定修正。
          </AtNoticebar>
          <View>
            <AtSearchBar
              value={searchValue}
          ...
          <View>
            <View>
              ...
              <CategoryList isReadMode={isReadMode} type='' options={antiTerrorismLawCategoryLines} onClick={this.onClickOptionItem} />}
            </View>
            <View>
