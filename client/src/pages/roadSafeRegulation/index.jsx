...
import './index.scss'
import {roadSafeRegulationCategoryLines} from '../../util/util';
...
export default class Index extends Component {
  ...
  config = {
    navigationBarTitleText: '道路交通安全法实施条例'
  }
      ...
      <View className={`litigation-regulation-page ${isReadMode ? 'read-mode' : ''}`}>
          ...
          <View>
            <View>
              ...
              <CategoryList isReadMode={isReadMode} type='' options={roadSafeRegulationCategoryLines} onClick={this.onClickOptionItem} />}
            </View>
            <View>
