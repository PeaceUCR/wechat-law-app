...
import './index.scss'
import {adminPunishLawCategoryLines} from '../../util/util';
...
export default class Index extends Component {
  ...
  config = {
    navigationBarTitleText: '中华人民共和国行政处罚法'
  }
      ...
      <View className={`litigation-regulation-page ${isReadMode ? 'read-mode' : ''}`}>
          ...
          <View>
            <View>
              ...
              <CategoryList isReadMode={isReadMode} type='' options={adminPunishLawCategoryLines} onClick={this.onClickOptionItem} />}
            </View>
            <View>
