...
import {rank, rankBySearchValue, rankCriminalList} from '../../util/rank'
  ...
  onSearch = () => {
    ...
    Taro.cloud.callFunction({
      ...
      complete: ({ result }) => {
        ...
        that.setState({searchResult: rankCriminalList(result.data, searchValue), isLoading: false, hasSearched: true});
      }
    })
