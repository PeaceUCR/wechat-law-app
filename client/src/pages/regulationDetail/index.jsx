...
export default class RegulationDetail extends Component {
  ...
  handleCollect = throttle(() => {
    ...
    if (isCollected) {
      ...
      let title;
      if (type === 'litigation-explanation' || type === 'police' || type === 'police-admin-regulation' || type === 'public-order-admin-penalty-law' || type === 'supervision-law' || type === 'admin-punish-law' || type === 'labor-law' || type === 'labor-contract-law' || type === 'road-safe-law' || type === 'road-safe-regulation' || type === 'anti-terrorism-law' || type === 'anti-drug-law' || type === 'admin-litigation-law' || type === 'admin-litigation-explaination') {
        title = number
    ...
    return (
      <View className={`term-detail-page ${isReadMode ? 'read-mode' : ''} ${zoomIn ? 'zoom-in' : ''}`}>
        ...
        <View className='main section'>
            <View>
              {(type === 'police' || type === 'civil-law-regulation' || type === 'police-admin-regulation' || type === 'public-order-admin-penalty-law' || type === 'supervision-law' || type === 'admin-punish-law' || type === 'labor-law' || type === 'labor-contract-law' || type === 'road-safe-law' || type === 'road-safe-regulation' || type === 'anti-terrorism-law' || type === 'anti-drug-law'|| type === 'admin-litigation-law'|| type === 'admin-litigation-explaination') && this.renderAdminText()}
