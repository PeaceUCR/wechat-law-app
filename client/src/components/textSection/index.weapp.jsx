...
const highlights = ['指导案例', '裁判要点', '相关法条', '相关法律规定', '基本案情', '裁判结果', '裁判理由', '刑法', '关键词', '要旨', '基本案情', '诉讼过程', '检察工作情况', '检察机关监督情况', '指导意义', '相关规定', '一、基本案情', '二、主要问题', '三、裁判理由','检察机关履职过程', '检察机关履职情况','裁判要旨','条文主旨','条文理解'];
const refine = (str) => {
  if(str && str.length > 0) {
